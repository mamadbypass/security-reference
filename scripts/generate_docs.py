...
def render_page(rel_path: str, meta: dict) -> str:
    ...
    if meta.get("exploitation"):
        lines += ["## Exploitation", "", meta["exploitation"].strip(), ""]
    ...
    if meta.get("commands"):
        ...
        lines.append("```bash")
        lines.append(meta["commands"].strip())
        lines.append("```")
        lines.append("")
        lines += [
            "!!! tip \"Full Tool Guide\"",
    ...
    if meta.get("payloads"):
        lines += ["## Example Payloads", ""]
        lines.append("```")
        lines.append(meta["payloads"].strip())
        lines.append("```")
        lines.append("")
    ...
    for item in meta.get("checklist", [
