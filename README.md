...
> **First-time setup:** Enable GitHub Pages at [Settings → Pages](https://github.com/mamadbypass/security-reference/settings/pages) → Source: **Deploy from a branch** → Branch: **gh-pages** / **/ (root)** → Save. The site will be live in 1–2 minutes.
